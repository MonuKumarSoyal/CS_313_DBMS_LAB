 ...
 <div class="Features">
         <div class="container">
            ...
            <div class="row d-flex justify-content-around">
               <div class="col-md-4">
                  <div class="Our_box" style="background-color:#e1e1bd; width:300px; height:640px">
               ...
               <div class="col-md-4">
                  <div class="Our_box" style="background-color:#e1e1bd; width:300px; height:640px">
                     <i><img src="./Formcss/Images/rahul.jpeg" alt="#"/></i>
                     <h4>Name: Rahul Prajapat</h4>
                     <h4>Roll No: 200010043</h4>
                     <h4>Email Id: 200010043@iitdh.ac.in</h4>
                  </div>
               </div>
            </div>
         </div>
